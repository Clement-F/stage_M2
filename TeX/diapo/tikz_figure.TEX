...
\draw[gray,  thick,dashed] (-2, -4/2) -- (-3,-4/2);
\draw[gray,  thick,dashed] (2, 2/2)  -- ( 3,2/2);
...
\coordinate (s1) at (0,0.5) ;\coordinate (s2) at (1,1.5) ;\coordinate (s3) at (-1,-1.5);
\coordinate (s4) at (2.7,0.5) ;\coordinate (s5) at (2.7,1.5) ;
\coordinate (s6) at (-2.7,0.5) ;\coordinate (s7) at (-2.7,-1.5) ;
