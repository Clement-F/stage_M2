...
\begin{equation}
    \Omega = \{(\rho,\rho v,\rho e)\quad | \quad \rho >0, \quad p= \rho e - \rho \frac{|v|^2}{2} >0\}
\end{equation}
Là où il est facile de vérifier $\rho >0$ en reprenant la condition du maximum global. Il est moins facile d'obtenir une condition pour la positivité de $p$. 
Il n'est cependant pas impossible d'imposer un tel critère : en supposant $\rho >0$, on cherche un critère pour obtenir $\rho \,\rho e - \frac{|\rho v|^2}{2} >0$.\\
