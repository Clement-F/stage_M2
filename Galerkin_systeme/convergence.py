...
plt.loglog(nx[0:5],err_L2[0:5],linestyle ='-',marker='v',markersize=10, label="pos")
plt.loglog(nx[5:10],err_L2[5:10],linestyle ='-',marker='o', label="LMP")
plt.loglog(nx[10:15],err_L2[10:15],linestyle ='-',marker='x',markersize=10, label="LMP + Relax")
