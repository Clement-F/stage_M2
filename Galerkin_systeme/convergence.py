...
# plt.loglog(nx,err_L1,linestyle ='None',marker='x', label="err_L1")
plt.loglog(nx[0:11],err_L2[0:11],linestyle ='-',marker='v',markersize=10, label="PMG")
plt.loglog(nx[11:17],err_L2[11:17],linestyle ='-',marker='o', label="LMP")
plt.loglog(nx[17:],err_L2[17:],linestyle ='-',marker='x',markersize=10, label="LMP + Relax")
# plt.loglog(nx[15:],err_L2[15:],linestyle ='-',marker='x', label="GMP")
